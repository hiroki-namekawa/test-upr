...
$site_top = "http://upr-net.co.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "powerassistsuits@upr-net.co.jp";
...
$require = array('御社名','部署名','姓','名','電話番号','メールアドレス');
...
$refrom_name = "ユーピーアール株式会社";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "パワーアシストスーツ デモ依頼ありがとうございました";
...
東京本社
〒100-0011
東京都千代田区内幸町1-3-2　内幸町東急ビル12Ｆ
TEL:03-3593-1730（代）　FAX:03-3593-3020
宇部本社
〒759-0134　山口県宇部市善和川東541-12
TEL:0836-62-1112（代）　FAX:0836-62-1417
E-mail: mail-haishin@upr-net.co.jp
URL:  http://www.upr-net.co.jp
──────────────────────
