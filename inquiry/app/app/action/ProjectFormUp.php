...
class Esform_Form_ProjectFormUp extends Esform_ActionForm
{
...
class Esform_Action_ProjectFormUp extends Esform_Action_Project
{
	function perform()
	{
		...
		if ($index > 0 && $index < count($attr_list)) {
