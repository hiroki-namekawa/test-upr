<?php /* Smarty version 2.6.19, created on 2015-11-05 13:35:51
         compiled from enquete.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'enquete.tpl', 22, false),)), $this); ?>
...
if ($this->_foreach['vote']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['vote']):
        $this->_foreach['vote']['iteration']++;
?>
		<tr>
			<td><?php echo $this->_foreach['vote']['iteration']; ?>
</td>
			<td><?php echo ((is_array($_tmp=$this->_tpl_vars['key'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php echo $this->_tpl_vars['item']['suffix']; ?>
</td>
			<td><?php echo $this->_tpl_vars['vote']['vote']; ?>
票</td>
			<td class="graph"><em style="width: <?php echo $this->_tpl_vars['vote']['width']; ?>
%;"><span><?php echo $this->_tpl_vars['vote']['rate']; ?>
%</span></em></td>
		</tr>
