...
<?/* form_part_p */?>
				...
				<tr class="zebra1">
					...
					<td>
						<div>
							<?error($vars, 't9kb')?>
							<input type="text" id="t9kb" name="t9kb" size="30" value="<?=$t9kb_v?>" style="ime-mode: auto;" /><br />
		...
		<label for="c1wf0"><input type="checkbox" id="c1wf0" name="c1wf[]" value="パレット及び物流機器のレンタル・販売"<?=$c1wf0_v?> />パレット及び物流機器のレンタル・販売</label>
		<label for="c1wf1"><input type="checkbox" id="c1wf1" name="c1wf[]" value="なんでも追跡システム「なんつい」"<?=$c1wf1_v?> />なんでも追跡システム「なんつい」</label>
		<label for="c1wf2"><input type="checkbox" id="c1wf2" name="c1wf[]" value="ワールドキーパー"<?=$c1wf2_v?> />ワールドキーパー</label>
		<label for="c1wf3"><input type="checkbox" id="c1wf3" name="c1wf[]" value="遠隔監視制御システム「なんモニ」"<?=$c1wf3_v?> />遠隔監視制御システム「なんモニ」</label>
		<label for="c1wf4"><input type="checkbox" id="c1wf4" name="c1wf[]" value="カーシェアリング"<?=$c1wf4_v?> />カーシェアリング</label>
		<label for="c1wf5"><input type="checkbox" id="c1wf5" name="c1wf[]" value="パワーアシストスーツ"<?=$c1wf5_v?> />パワーアシストスーツ</label>
