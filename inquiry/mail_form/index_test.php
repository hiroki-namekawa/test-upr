...
<head>
	...
	<link rel="stylesheet" type="text/css" href="http://test.upr-net.co.jp/inquiry/mail_form/app/common.css" media="all" />
	<script type="text/javascript" src="http://test.upr-net.co.jp/inquiry/mail_form/app/prototype.js"></script>
	<script type="text/javascript" src="http://test.upr-net.co.jp/inquiry/mail_form/app/common.js"></script>
</head>
...
<?/* confirm_part_p */?>
	...
	<form action="mail_form/inquiry.php" method="post">
		<fieldset>
...
<? ELSE : ?>
	...
	<form action="mail_form/inquiry.php" method="post" enctype="multipart/form-data" accept-charset="utf-8" id="inputform">
		<fieldset>
			<legend>お問い合わせフォーム</legend>
